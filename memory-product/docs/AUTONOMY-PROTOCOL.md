...
**Status:** v1 — drafted 2026-04-30 night. First experiment is CP9 (`GET /memories/{id}/source`).
...
2. **Schema change needed.** Migration files are out of scope for autonomous runs in v1. If a task needs schema change, halt.
...
- **No production migrations from autonomous runs.** Migrations are reviewed by Justin.
